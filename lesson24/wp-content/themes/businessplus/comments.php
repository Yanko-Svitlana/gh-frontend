...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( // WPCS: XSS OK.
					esc_html( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'businessplus' ) ),
		...
		<ol class="comment-list">
			...
			wp_list_comments( array(
				'style'      => 'ol',
				'short_ping' => true,
				'callback'     => 'businessplus_list_comment',
				'max_depth'  => 2
			) );
			?>
		</ol><!-- .comment-list -->
